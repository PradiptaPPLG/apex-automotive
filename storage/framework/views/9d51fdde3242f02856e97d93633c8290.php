    ...
    <main class="flex-grow">
        ...
        <section id="hero-carousel" class="relative w-full h-[85vh] min-h-[550px] max-h-[900px] overflow-hidden bg-black">
            ...
            <div class="hero-slide absolute inset-0 transition-opacity duration-1000 ease-in-out opacity-0 z-0" data-index="5">
                <div class="absolute inset-0 bg-gradient-to-t from-[#0a0a0c] via-black/40 to-black/60 z-10"></div>
                <img src="<?php echo e(asset('images/carousell/carousell6.webp')); ?>" alt="Chevrolet Camaro" class="w-full h-full object-cover object-center transform scale-100 transition-transform duration-[8000ms] ease-out hero-img">
                <div class="absolute inset-0 z-20 flex flex-col justify-end max-w-7xl mx-auto px-6 lg:px-8 pb-16 lg:pb-24">
                    <div class="space-y-4 max-w-3xl">
                        <div class="flex items-center space-x-3">
                            <span class="red-divider-line"></span>
        ...
        <section id="certified-suggestions" class="py-20 bg-white dark:bg-[#0a0a0c] text-neutral-900 dark:text-neutral-100 border-b border-neutral-200 dark:border-white/5 relative transition-colors duration-300">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="carCatalog">
                    ...
                    ?>
                    <?php $__currentLoopData = $sortedCars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="car-card glass-card group cursor-pointer overflow-hidden border border-neutral-200 dark:border-white/10 hover:border-red-600 transition-all duration-300 reveal-on-scroll" data-make="<?php echo e($car->brand); ?>" data-price="<?php echo e($car->price); ?>" data-condition="<?php echo e($car->category); ?>" onclick="openCarInspector('<?php echo e($car->id); ?>')">
                        <div class="relative h-64 overflow-hidden bg-neutral-900">
                            ...
                            ?>
                            <div class="absolute top-3 left-3 <?php echo e($statusColor); ?> text-[10px] font-mono font-bold px-2 py-0.5 uppercase tracking-widest shadow-md flex items-center space-x-1">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="relative h-[380px] rounded-none border border-white/10 overflow-hidden reveal-on-scroll">
                        ...
                        <div class="absolute inset-0 z-20 flex flex-col justify-end p-6 bg-transparent pointer-events-none">
                            ...
                            <div class="pt-4 mt-2 flex gap-3 pointer-events-auto">
                                <a href="<?php echo e(route('service.create')); ?>" class="flex-1 px-3 py-3 bg-red-600 hover:bg-red-700 text-white text-[9px] tracking-widest font-bold uppercase transition-all duration-300 flex items-center justify-center shadow-lg shadow-red-600/30">
                                    <i class="fa-solid fa-calendar-check mr-2"></i> BOOK APPT
                                </a>
                                <a href="https://maps.google.com/?q=<?php echo e($dealer_lat ?? '-7.3274'); ?>,<?php echo e($dealer_lng ?? '108.3225'); ?>" target="_blank" class="flex-1 px-3 py-3 border border-white/30 hover:border-white text-white text-[9px] tracking-widest font-bold uppercase transition-all duration-300 flex items-center justify-center backdrop-blur-md bg-black/50">
                    ...
                    <div id="showroom360Card" class="relative h-[380px] rounded-none overflow-hidden border border-white/10 group reveal-on-scroll" style="cursor:pointer;">
                        <img src="<?php echo e(asset('images/experience-showroom.webp')); ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-16 border-b border-white/10">
                ...
                <div class="lg:col-span-2 space-y-4">
                    ...
                    <p class="text-xs text-neutral-400 font-light max-w-sm leading-relaxed">
                        <?php echo e(\App\Models\Setting::where('key', 'footer_desc')->value('value') ?? 'Official Cijeungjing luxury supercar showroom. Authorized partner for high-performance exotics, certified pre-owned supercars, and factory-trained racing maintenance.'); ?>

                    </p>
                    <div class="flex space-x-4 pt-2 text-base text-neutral-400">
                        <a href="<?php echo e(\App\Models\Setting::where('key', 'social_instagram')->value('value') ?? '#'); ?>" class="hover:text-red-500 transition-colors"><i class="fa-brands fa-instagram"></i></a>
                        <a href="<?php echo e(\App\Models\Setting::where('key', 'social_youtube')->value('value') ?? '#'); ?>" class="hover:text-red-500 transition-colors"><i class="fa-brands fa-youtube"></i></a>
                        <a href="<?php echo e(\App\Models\Setting::where('key', 'social_facebook')->value('value') ?? '#'); ?>" class="hover:text-red-500 transition-colors"><i class="fa-brands fa-facebook"></i></a>
                        <a href="<?php echo e(\App\Models\Setting::where('key', 'social_linkedin')->value('value') ?? '#'); ?>" class="hover:text-red-500 transition-colors"><i class="fa-brands fa-linkedin"></i></a>
                    </div>
                </div>
            ...
            _360viewer = pannellum.viewer('pannellum360Viewer', {
                ...
                scenes: {
                    showroom: {
                        ...
                        panorama: '<?php echo e(asset("images/showroom_360.png")); ?>',
                        hotSpots: [
                    ...
                    garage: {
                        type: 'equirectangular',
                        panorama: '<?php echo e(asset("images/garage_360.png")); ?>',
                        hotSpots: [
                    ...
                    lounge: {
                        type: 'equirectangular',
                        panorama: '<?php echo e(asset("images/lounge_360.png")); ?>',
                        hotSpots: [
                    ...
                    front: {
                        type: 'equirectangular',
                        panorama: '<?php echo e(asset("images/front_360.png")); ?>',
                        hotSpots: [
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (mapEl) {
            var lat = <?php echo e($dealer_lat); ?>;
            var lng = <?php echo e($dealer_lng); ?>;
