                ...
                <div style="position: relative;" id="topbarUserWrapper">
                    ...
                    <div class="topbar-dropdown" id="topbarDropdown">
                        <div class="topbar-dropdown-header">
                            ...
                            <div style="font-size: 12px; color: var(--text-muted); word-break: break-all;"><?php echo e(auth()->user()->email); ?></div>
                        </div>
                        <div style="padding: 6px 0;">
                            <a href="<?php echo e(route('manager.profile.show')); ?>" class="topbar-dropdown-link">
