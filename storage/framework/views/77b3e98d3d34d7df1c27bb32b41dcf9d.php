...
<body>
    <nav class="admin-nav">
        <div class="admin-nav-left">
            <a href="<?php echo e(route('home')); ?>" class="admin-nav-logo">
                <img src="<?php echo e(asset('images/logo/logo.png')); ?>" alt="Apex">
            </a>
        ...
        <div class="admin-nav-right">
            ...
            <a href="<?php echo e(route('admin.profile.show')); ?>" style="color:var(--text-base); text-decoration:none; font-family:'Space Mono', monospace; font-size:10px; text-transform:uppercase; border:1px solid rgba(220,38,38,0.4); padding:4px 10px; border-radius:4px; transition:all 0.2s; background:rgba(220,38,38,0.1);">
    ...
    <main class="main">
        <div class="page-header">
            ...
            <div class="filter-tabs">
                <a href="<?php echo e(route('admin.inquiries.index')); ?>" class="filter-tab <?php echo e(!$status ? 'active' : ''); ?>">Semua</a>
                <?php $__currentLoopData = \App\Models\Inquiry::statusLabels(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('admin.inquiries.index', ['status' => $code])); ?>" class="filter-tab <?php echo e($status === $code ? 'active' : ''); ?>">
                        <?php echo e($label); ?>
        ...
        <?php $allInquiries = \App\Models\Inquiry::all(); ?>
        <div class="stats-row">
            <div class="stat-card">
                <div class="stat-num"><?php echo e($allInquiries->count()); ?></div>
                <div class="stat-label">Total Inquiry</div>
            </div>
            <div class="stat-card">
                <div class="stat-num"><?php echo e($allInquiries->where('status','inquiry_received')->count()); ?></div>
                <div class="stat-label">Lead Baru</div>
            </div>
            <div class="stat-card">
                <div class="stat-num"><?php echo e($allInquiries->where('status','consultation_active')->count()); ?></div>
                <div class="stat-label">Konsultasi Aktif</div>
            </div>
            <div class="stat-card">
                <div class="stat-num"><?php echo e($allInquiries->whereIn('status',['payment_verified','delivered_completed'])->count()); ?></div>
        ...
        <table class="inquiries-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $inquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr onclick="window.location='<?php echo e(route('admin.inquiries.show', $inquiry)); ?>'">
                        <td class="td-date"><?php echo e($inquiry->id); ?></td>
                        <td>
                            <div class="td-name"><?php echo e($inquiry->name); ?></div>
                            <div class="td-phone"><?php echo e($inquiry->email); ?></div>
                        </td>
                        <td class="td-car"><?php echo e($inquiry->car_model ?? '—'); ?></td>
                        <td class="td-phone"><?php echo e($inquiry->phone); ?></td>
                        <td><span class="status-pill <?php echo e($inquiry->statusColor()); ?>"><?php echo e($inquiry->statusLabel()); ?></span></td>
                        <td style="color: var(--text-base);">
                            <?php echo e($inquiry->messages_count); ?>

                            <?php if($inquiry->unread_count > 0): ?>
                                <span class="unread-badge"><?php echo e($inquiry->unread_count); ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="td-date"><?php echo e($inquiry->created_at->format('d M Y')); ?></td>
...
<?php /**PATH C:\xampp\htdocs\apex-automotive\resources\views/admin/inquiries.blade.php ENDPATH**/ ?>