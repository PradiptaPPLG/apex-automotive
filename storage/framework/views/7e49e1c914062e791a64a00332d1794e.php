...
<body>
    ...
    <div class="bg-container">
        <?php if(!empty($enableVideo)): ?>
            <video class="bg-video" autoplay muted loop playsinline preload="metadata" poster="<?php echo e(asset('images/carousell/carousell1.png')); ?>">
                <source src="<?php echo e(asset('intro_login.mp4')); ?>" type="video/mp4">
            </video>
        <?php else: ?>
            <img class="bg-video" src="<?php echo e(asset('images/carousell/carousell1.png')); ?>" alt="Apex Background" style="object-fit: cover; filter: brightness(0.65);">
        <?php endif; ?>
        ...
        <div class="right-content">
            <div class="login-card">
                ...
                <div class="brand-header">
                    <img src="<?php echo e(asset('images/logo/logo.png')); ?>" alt="Apex Logo" class="brand-logo">
                    <div>
                ...
                <!-- EMAIL STEP FORM -->
                <form id="emailStepForm" action="<?php echo e(route('auth.send-otp')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p style="color: #ef4444; font-size: 11px; font-family: monospace; margin-top: 6px;"><?php echo e($message); ?></p>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="otp-modal <?php if(request('verify') || session('email_sent')): ?> active <?php endif; ?>" id="otpPopup">
                    ...
                    <p style="font-size: 11px; color: rgba(255,255,255,0.6); margin: 0; line-height: 1.4;">
                        ...
                        <strong id="displayTargetEmail" style="color: #fff;"><?php echo e(session('email_sent', old('email'))); ?></strong>
                    </p>

                    <form action="<?php echo e(route('auth.verify-otp')); ?>" method="POST" style="width: 100%;">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="email" id="modalOtpEmail" value="<?php echo e(session('email_sent', old('email'))); ?>">
                        <input type="hidden" name="otp" id="modalOtpHidden">

                        <div class="otp-boxes">
                            <?php for($i = 0; $i < 6; $i++): ?>
                                <input type="text" inputmode="numeric" maxlength="1" class="otp-digit modal-otp-box" id="modal-otp-<?php echo e($i); ?>" autocomplete="off">
                            <?php endfor; ?>
                        </div>
    ...
    <script>
        ...
        async function onScanSuccess(decodedText) {
            ...
            try {
                const response = await fetch("<?php echo e(route('login.qr')); ?>", {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\xampp\htdocs\apex-automotive\resources\views/auth/login.blade.php ENDPATH**/ ?>