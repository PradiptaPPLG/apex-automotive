...
<div class="ai-assist-box" id="navAssistWrapper" style="display:block;">
        ...
        <div class="ai-assist-orb" id="aiAssistOrb" aria-label="Menu VIP">
            <link rel="preload" href="<?php echo e(asset('images/logo/staff/neura_ai_pose_1.webp')); ?>" as="image">
            <link rel="preload" href="<?php echo e(asset('images/logo/staff/neura_ai_pose_2.webp')); ?>" as="image">
            <link rel="preload" href="<?php echo e(asset('images/logo/staff/neura_ai_pose_3.webp')); ?>" as="image">
            <link rel="preload" href="<?php echo e(asset('images/logo/staff/neura_ai_pose_4.webp')); ?>" as="image">
            <link rel="preload" href="<?php echo e(asset('images/logo/staff/neura_ai_pose_5.webp')); ?>" as="image">
            ...
            <img src="<?php echo e(asset('images/logo/staff/neura_ai_pose_1.webp')); ?>" alt="STAFF" id="vAvatarBtn" style="position:relative; z-index:2;">
        </div>
</div>
...
<div class="ai-assist-pane" id="aiAssistPane">
    <div class="v-hdr">
        <div class="v-hdr-info">
            <div class="v-hdr-img">
                <img src="<?php echo e(asset('images/logo/staff/neura_ai_pose_1.webp')); ?>" alt="STAFF" id="vAvatarHdr">
            </div>
            <div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const f1 = "<?php echo e(asset('images/logo/staff/neura_ai_pose_1.webp')); ?>";
        const f2 = "<?php echo e(asset('images/logo/staff/neura_ai_pose_2.webp')); ?>";
        const f3 = "<?php echo e(asset('images/logo/staff/neura_ai_pose_3.webp')); ?>";
        const f4 = "<?php echo e(asset('images/logo/staff/neura_ai_pose_4.webp')); ?>";
        const f5 = "<?php echo e(asset('images/logo/staff/neura_ai_pose_5.webp')); ?>";
        ...
        async function vAPI(m) {
            try {
                const u = "<?php echo e(route('api.chat')); ?>";
...
<?php /**PATH C:\xampp\htdocs\apex-automotive\resources\views/partials/chatbot.blade.php ENDPATH**/ ?>