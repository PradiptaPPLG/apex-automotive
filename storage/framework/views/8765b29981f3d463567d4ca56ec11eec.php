...
<body>
    ...
    <div class="top-navbar">
        <a href="/" class="brand-logo-group">
            <img src="<?php echo e(asset('images/logo/logo.png')); ?>" alt="Apex Logo" class="brand-logo-img">
            <div>
        ...
        <div class="user-menu-wrapper">
            <div class="user-menu-btn">
                ...
                <span><?php echo e(auth()->user()->name ?? 'VIP Buyer'); ?></span>
    ...
    <div class="container">
        ...
        <div class="form-card">
            ...
            <!-- FORM -->
            <form action="<?php echo e(route('profile.save')); ?>" method="POST" id="profileForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div id="step-section-1">
                    <div class="form-grid">
                        <div class="field-group full-width">
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', auth()->user()->name)); ?>" class="input-box" required placeholder="Contoh: Pradipta Endra">
                        </div>

                        <div class="field-group">
                            <label class="field-label">Nomor WhatsApp <span class="req">*</span></label>
                            <input type="tel" name="phone" value="<?php echo e(old('phone', auth()->user()->phone)); ?>" class="input-box" required placeholder="08123456789">
                        </div>

                        <div class="field-group">
                            <label class="field-label">Alamat Email Terverifikasi</label>
                            <input type="email" value="<?php echo e(auth()->user()->email); ?>" class="input-box" disabled>
                        </div>
                    </div>
                ...
                <div id="step-section-2" style="display: none;">
                    <div class="field-group full-width" style="margin-bottom: 20px;">
                        ...
                        <div style="display: flex; gap: 12px; margin-top: 6px; flex-wrap: wrap;">
                            <label style="display: flex; align-items: center; gap: 8px; font-size: 12px; font-family: monospace; cursor: pointer; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.15); padding: 12px 16px; border-radius: 2px; flex: 1; min-width: 200px;">
                                <input type="radio" name="ownership_type" value="individual" <?php echo e(old('ownership_type', auth()->user()->ownership_type ?? 'individual') === 'individual' ? 'checked' : ''); ?> onchange="toggleOwnershipFields(this.value)" style="accent-color: #e50914;">
                                <span><i class="fa-solid fa-user text-red-500 mr-1.5"></i> Atas Nama Perorangan</span>
                            </label>
                            <label style="display: flex; align-items: center; gap: 8px; font-size: 12px; font-family: monospace; cursor: pointer; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.15); padding: 12px 16px; border-radius: 2px; flex: 1; min-width: 200px;">
                                <input type="radio" name="ownership_type" value="company" <?php echo e(old('ownership_type', auth()->user()->ownership_type) === 'company' ? 'checked' : ''); ?> onchange="toggleOwnershipFields(this.value)" style="accent-color: #e50914;">
                    ...
                    <div class="form-grid">
                        <div class="field-group full-width">
                            ...
                            <input type="text" name="nik" value="<?php echo e(old('nik', auth()->user()->nik)); ?>" maxlength="16" class="input-box" required placeholder="16 Digit Angka KTP">
                        </div>

                        <div class="field-group full-width">
                            <label class="field-label">Nomor Pokok Wajib Pajak (NPWP)</label>
                            <input type="text" name="npwp" value="<?php echo e(old('npwp', auth()->user()->npwp)); ?>" class="input-box" placeholder="Opsional / Wajib untuk PT">
                        </div>
                ...
                <div id="step-section-3" style="display: none;">
                    <div class="form-grid">
                        <div class="field-group full-width">
                            ...
                            <textarea name="address" class="input-box" required placeholder="Nama jalan, gedung, nomor rumah, RT/RW"><?php echo e(old('address', auth()->user()->address)); ?></textarea>
                        </div>

                        <div class="field-group">
                            <label class="field-label">Kota / Kabupaten <span class="req">*</span></label>
                            <input type="text" name="city" value="<?php echo e(old('city', auth()->user()->city)); ?>" class="input-box" required placeholder="Contoh: Cijeungjing Selatan">
                        </div>

                        <div class="field-group">
                            <label class="field-label">Provinsi <span class="req">*</span></label>
                            <input type="text" name="province" value="<?php echo e(old('province', auth()->user()->province)); ?>" class="input-box" required placeholder="Contoh: Jawa Barat">
                        </div>

                        <div class="field-group full-width">
                            <label class="field-label">Kode Pos <span class="req">*</span></label>
                            <input type="text" name="postal_code" value="<?php echo e(old('postal_code', auth()->user()->postal_code)); ?>" maxlength="6" class="input-box" required placeholder="12240">
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\apex-automotive\resources\views/auth/complete-profile.blade.php ENDPATH**/ ?>