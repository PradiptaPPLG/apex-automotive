                                    ...
                                    <div class="location-card" data-location="{{ trim($lat) }},{{ trim($lng) }}" data-mapid="{{ $mapId }}">
                                        <div style="display:flex; justify-content:space-between; align-items:center;">
                                            ...
                                            <div class="loc-menu-wrap" style="position:relative;">
                                                ...
                                                <div id="loc-dropdown-{{ $msg->id }}" class="loc-dropdown" style="display:none; position:absolute; right:0; top:24px; background:#0a0a14; border:1px solid rgba(34,211,238,0.4); border-radius:4px; z-index:9999; width:175px; box-shadow:0 12px 35px rgba(0,0,0,0.95);">
